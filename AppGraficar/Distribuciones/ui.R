                  ...
                  tabItems(
                      ...
                      tabItem(tabName = "cauchy",
                              ...
                              tabsetPanel(type = "tabs",
                                          ...
                                          tabPanel("Funación de densidad",
                                                   
                                                   uiOutput("formula_cauchy")
